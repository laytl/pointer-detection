...
train_dataset = pdx.datasets.SegDataset(
    data_dir='meter-seg-new',
    file_list='meter-seg-new/train.txt',
    label_list='meter-seg-new/labels.txt',
    transforms=train_transforms,
    shuffle=True)

eval_dataset = pdx.datasets.SegDataset(
    data_dir='meter-seg-new',
    file_list='meter-seg-new/val.txt',
    label_list='meter-seg-new/labels.txt',
...
model=pdx.seg.FastSCNN(num_classes=num_classes, use_mixed_loss=True)
